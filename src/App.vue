        ...
        <div class="footer-cta">
          <div class="developer-info">
            ...
            <div class="developer-details">
              ...
              <a href="https://www.linkedin.com/in/mmervekayaa " target="_blank" class="developer-name" style="text-decoration: none; color: inherit; cursor: pointer;">
                <h3>Merve KAYA</h3>
              </a>
              <div class="developer-role">HSD Fırat</div>
            </div>
          </div>
        </div>
      </div>
